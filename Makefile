...
# add [enable-split-platform enable-debug disable-gpl] to .PHONY can ignore target not exist error.
.PHONY: help build clean enable-split-platform enable-debug disable-gpl
...
help:
	...
	@echo "                            disable-gpl               Complile to LGPL version"
